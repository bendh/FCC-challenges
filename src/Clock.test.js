...
test.each`
  ...
  ${'break-label'} | ${'Session Length'}| ${'User Story #2: I can see an element with id="session-label" that contains a string (e.g. "Session Length").'}
`('$story', ({ cssId, htmlContent, story}) => {
...
test.skip('User Story #7: I can see an element with a corresponding id="timer-label", that contains a string indicating a session is initialized (e.g. "Session").', ()=>{

});

test.skip('User Story #8: I can see an element with corresponding id="time-left". NOTE: Paused or running, the value in this field should always be displayed in mm:ss format (i.e. 25:00).', ()=> {

});

test.skip.each`
cssId | story
${'start-stop'} | ${'User Story #9: I can see a clickable element with a corresponding id="start_stop".'}
